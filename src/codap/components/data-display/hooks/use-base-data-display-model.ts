...
import { BaseDataDisplayModel } from "../models/base-data-display-content-model"

export const BaseDataDisplayModelContext = createContext<BaseDataDisplayModel | undefined>(undefined)
