  ...
  useEffect(() => {
    ...
    reaction(() => items.length,
      () => {
        ...
        const facingQuanternion = new THREE.Quaternion();
        facingQuanternion.setFromEuler(dstCamera.facingRotation);
        points.current.addInstances(items.length, (instance, index) => {
          const aCase = items[index];
          ...
          instance.applyQuaternion(facingQuanternion);
