...
export const backgroundLongRange = kBackgroundLongMax - kBackgroundLongMin;
export const kBackgroundLongMid = kBackgroundLongMin + backgroundLongRange / 2;
...
export const kBackgroundLatMid = baseBackgroundLatMid;
